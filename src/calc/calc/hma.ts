 ...
 */
function wmaArray(values: ReadonlyArray<number | null>, length: number): (number | null)[] {
...
export function calcHMA(candles: CandlePoint[], params?: IndicatorParams): IndicatorPoint[] {
