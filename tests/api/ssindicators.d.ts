...
// Public API module: math/decimal-semantics.d.ts
/**
 ...
 */
export declare function isPlatformZero(value: number, scale: number): boolean;
/**
 ...
 */
export declare const PLATFORM_SMALLEST = 1e-28;
/**
 ...
 * to avoid.
 */
export declare function platformDecimal(value: number): number;
